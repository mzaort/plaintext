...
function startup1() {
  ...
  b1.setTooltip('I changed the tooltip using setTooltip() ' + 'after the button was rendered.');
  goog.events.listen(b1, EVENTS, logEvent);

  goog.events.listen(goog.dom.getElement('b1_enable'), goog.events.EventType.CLICK, function(e) {
    b1.setEnabled(e.target.checked);
  });

  goog.events.listen(b1, goog.ui.Component.EventType.ACTION, function(e) {
  ...
  goog.events.listen(b2, goog.ui.Component.EventType.ACTION, function(e) {
  ...
  var fb1 = new goog.ui.Button('Hello!', goog.ui.FlatButtonRenderer.getInstance());
  fb1.render(goog.dom.getElement('fb1'));
  fb1.setTooltip('I changed the tooltip using setTooltip() ' + 'after the button was rendered.');
  goog.events.listen(fb1, EVENTS, logEvent);

  goog.events.listen(goog.dom.getElement('fb1_enable'), goog.events.EventType.CLICK, function(e) {
  ...
  goog.events.listen(goog.dom.getElement('fb2_enable'), goog.events.EventType.CLICK, function(e) {
    fb2.setEnabled(e.target.checked);
  });

  goog.events.listen(fb2, goog.ui.Component.EventType.ACTION, function(e) {
  ...
  var lb = new goog.ui.Button('Hello!', goog.ui.LinkButtonRenderer.getInstance());
  lb.render(goog.dom.getElement('lb'));
  lb.setTooltip('I changed the tooltip using setTooltip() ' + 'after the button was rendered.');
  goog.events.listen(lb, EVENTS, logEvent);

  goog.events.listen(goog.dom.getElement('lb_enable'), goog.events.EventType.CLICK, function(e) {
    lb.setEnabled(e.target.checked);
  });

  goog.events.listen(lb, goog.ui.Component.EventType.ACTION, function(e) {
    var newCaption = window.prompt('Enter new caption for button:');
  ...
  goog.events.listen(toggleEnable, goog.ui.Component.EventType.ACTION, function(e) {
  ...
  goog.events.listen(hideShow, goog.ui.Component.EventType.ACTION, function(e) {
